...
public class ModifierPlatProposeActivity extends AppCompatActivity {
    String responseStr ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modifier_plat_propose);
        ...
        call.enqueue(new Callback() {
            ...
            public  void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    platAdapter = new ArrayAdapter<>(ModifierPlatProposeActivity.this, android.R.layout.simple_spinner_item, platList);
    ...
    public void modifier() throws IOException {
        ...
        Request request = new Request.Builder()
                .url("http://192.168.1.14/amphitryon/modeles/dao/modifierPlatProposee.php")
                .post(formBody)
                .build();
